...
export class GetInvoiceLineItemsByFilters200Response {
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<InvoiceV2LineItemResponse>"
        },
        {
            "name": "success",
            "baseName": "success",
    ...
    static getAttributeTypeMap() {
        return GetInvoiceLineItemsByFilters200Response.attributeTypeMap;
    }
}
